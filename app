...
function test {
    ...
    export DISPLAY=:0
    ./com.github.christophernugent.acacia --run-tests
    result=$?
...
"generate-i18n")
    initialize
    ninja com.github.christophernugent.acacia-pot
    ninja com.github.christophernugent.acacia-update-po
    ;;
"install")
    initialize
    sudo ninja install
...
"run")
    initialize
    ./com.github.christophernugent.acacia "${@:2}"
    ;;
"test")
    test
    ;;
